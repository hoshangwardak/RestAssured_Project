...
public class StarWarAPI_WarmUpTask {

    // https://swapi.dev/api

    @BeforeAll
    public static void settingUpStarWarAPI() {
    ...
    // then decide how many page we have to go through by sending more request
    ...
    public void testGetAllPagesAverageHeight(){
        ...
        // third page has a value unknown and it's somehow got stored since getList get all
    ...
    @AfterAll
    public static void cleanUpStarWarAPI() {
        reset();
    }
